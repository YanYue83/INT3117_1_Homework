...
# testing with all-use coverage
# 5 test case 
class TestDeliveryBill(unittest.TestCase):
    def setUp(self):
        self.test_cases = [
            (3, "thường", 60, 33000, None),
            (13, "thường", 5, 109200, None),
            (3, "nhanh", 60, ValueError, "Loại dịch vụ không hợp lệ!"),
            (3, "hỏa tốc", 30, 105000, None),
            (201, "hỏa tốc", 30, ValueError, "Trọng lượng không hợp lệ!")
        ]
